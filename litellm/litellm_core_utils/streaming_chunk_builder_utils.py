...
class ChunkProcessor:
    ...
    def _usage_chunk_calculation_helper(self, usage_chunk: Usage) -> "_UsageSummary":
        ...
        cache_creation_input_tokens: int | None = getattr(usage_chunk, "cache_creation_input_tokens", None)
        cache_read_input_tokens: int | None = getattr(usage_chunk, "cache_read_input_tokens", None)
        cost: float | None = getattr(usage_chunk, "cost", None)
