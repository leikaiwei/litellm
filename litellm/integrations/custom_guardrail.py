...
_DEPLOYMENT_PRE_CALL_TYPES: Final[dict[CallTypes, CallTypesLiteral]] = {
...
class CustomGuardrail(CustomLogger):
    ...
    async def async_pre_call_deployment_hook(self, kwargs: dict[str, Any], call_type: CallTypes | None) -> dict | None:
        ...
        hook_call_type: Final = _DEPLOYMENT_PRE_CALL_TYPES.get(call_type) if call_type is not None else None
