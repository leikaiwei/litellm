...
_ANTHROPIC_MESSAGES_CLIENT_HEADERS: Final = ("anthropic-beta", "anthropic-version")
...
class LiteLLMProxyRequestSetup:
    ...
    @staticmethod
    def add_anthropic_messages_headers_to_llm_call(data: dict, headers: dict, request_path: str) -> dict:
